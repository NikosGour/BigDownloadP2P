...
func commandLineArgs() (port int, is_receiver bool, address string, files []string, err error) {
...
Options:
	...
	flag.StringVar(&address, "a", "localhost", "The address to send the files to")
	flag.StringVar(&address, "address", "localhost", "The address to send the files to")
